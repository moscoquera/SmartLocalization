...
List<string> availableLanguages = LanguageManager.Instance.AvailableLanguages;

//Get a list of all the available languages (System.Globalization.CultureInfo)
List<CultureInfo> availableLanguages = LanguageManager.Instance.AvailableLanguagesCulture  Info;

//Get the system language( string = "en" "sv" "es" etc.)
string systemLanguage = LanguageManager.Instance.GetSystemLanguage();
